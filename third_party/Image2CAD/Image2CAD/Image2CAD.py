...
# --- 移植补丁2：OpenCV 中文路径读写兼容 ---
import numpy as _np


def _imread_u(path, flags=cv2.IMREAD_COLOR):
    try:
...
def _imwrite_u(path, img, params=None):
    import os as _os
...
cv2.imread = _imread_u
cv2.imwrite = _imwrite_u
